...
- **Current P1 verification-workload baseline:** 91 citation records (70
  distinct normalised strings), including 31 full citations, 29 short forms,
  16 *id.* citations, 15 *supra* citations, and 63 attached quotation claims.
  This excludes the table of authorities, as required by `FR-EXT-001`.
  The historical pre-exclusion count was 118 records (94 distinct strings;
  58 full, 29 short, 16 *id.*, and 15 *supra*): its 27 additional full
  citations were table-of-authorities entries and are intentionally not sent
  for verification.
...
materially changed current-workload count invalidates this baseline. This file is for the
